...
class SuggestResponse PROTOBUF_FINAL :
 ...
 public:
  ...
  enum : int {
    kSuggestAnswerFieldNumber = 1,
  };
  // repeated .suggest.SuggestAnswer suggest_answer = 1;
  int suggest_answer_size() const;
  private:
  int _internal_suggest_answer_size() const;
  public:
  void clear_suggest_answer();
  ::suggest::SuggestAnswer* mutable_suggest_answer(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::suggest::SuggestAnswer >*
      mutable_suggest_answer();
  private:
  const ::suggest::SuggestAnswer& _internal_suggest_answer(int index) const;
  ::suggest::SuggestAnswer* _internal_add_suggest_answer();
  public:
  const ::suggest::SuggestAnswer& suggest_answer(int index) const;
  ::suggest::SuggestAnswer* add_suggest_answer();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::suggest::SuggestAnswer >&
      suggest_answer() const;
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::suggest::SuggestAnswer > suggest_answer_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_suggest_2eproto;
};
// ===================================================================
...
// repeated .suggest.SuggestAnswer suggest_answer = 1;
inline int SuggestResponse::_internal_suggest_answer_size() const {
  return suggest_answer_.size();
}
inline int SuggestResponse::suggest_answer_size() const {
  return _internal_suggest_answer_size();
}
inline void SuggestResponse::clear_suggest_answer() {
  suggest_answer_.Clear();
}
inline ::suggest::SuggestAnswer* SuggestResponse::mutable_suggest_answer(int index) {
  // @@protoc_insertion_point(field_mutable:suggest.SuggestResponse.suggest_answer)
  return suggest_answer_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::suggest::SuggestAnswer >*
SuggestResponse::mutable_suggest_answer() {
  // @@protoc_insertion_point(field_mutable_list:suggest.SuggestResponse.suggest_answer)
  return &suggest_answer_;
}
inline const ::suggest::SuggestAnswer& SuggestResponse::_internal_suggest_answer(int index) const {
  return suggest_answer_.Get(index);
}
inline const ::suggest::SuggestAnswer& SuggestResponse::suggest_answer(int index) const {
  // @@protoc_insertion_point(field_get:suggest.SuggestResponse.suggest_answer)
  return _internal_suggest_answer(index);
}
inline ::suggest::SuggestAnswer* SuggestResponse::_internal_add_suggest_answer() {
  return suggest_answer_.Add();
}
inline ::suggest::SuggestAnswer* SuggestResponse::add_suggest_answer() {
  // @@protoc_insertion_point(field_add:suggest.SuggestResponse.suggest_answer)
  return _internal_add_suggest_answer();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::suggest::SuggestAnswer >&
SuggestResponse::suggest_answer() const {
  // @@protoc_insertion_point(field_list:suggest.SuggestResponse.suggest_answer)
  return suggest_answer_;
}
